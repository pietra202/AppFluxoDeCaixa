...
namespace AppFluxoDeCaixa.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FornecedorId,Name,CNPJ,Email,Telefone,DataCadastro,Ativo")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FornecedorId,Name,CNPJ,Email,Telefone,DataCadastro,Ativo")] Fornecedor fornecedor)
        {
